import { shippinFormSchema, ShippingFormInpust } from "@/types";
...
const ShippingForm = ({
  ...
  setShippingForm: (data: ShippingFormInpust) => void;
}) => {
  const {
    register,
    handleSubmit,
    formState: { errors },
  } = useForm<ShippingFormInpust>({
    resolver: zodResolver(shippinFormSchema),
  });

  const router = useRouter()
  const handleShippingForm: SubmitHandler<ShippingFormInpust> = (data) => {
